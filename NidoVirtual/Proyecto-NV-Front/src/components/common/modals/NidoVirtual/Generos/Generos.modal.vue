        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ isEdit ? 'Modificar Género' : 'Nuevo Género' }}</h5>
                    ...
                    <form @submit.prevent="handleSubmit">
                        <div class="row pb-3 pt-3">
                            <div class="col-12 pt-2">
                                ...
                                <input type="text" class="form-control" v-model="genero.descGenero" required>
                            </div>
                        </div>
...
const genero = ref<GenerosModel>(new GenerosModel());
...
const handleSubmit = () => {
    emit('save', props.isEdit ? { idGenero: props.genero.idGenero, descGenero: genero.value.descGenero } : { descGenero: genero.value.descGenero });
};
</script>
